...
public final class DummyAuthorizer implements Authorizer {
    ...
    @Override
    public void ensureAuthorized(Permission permission) throws UnauthorizedException {
        // do nothing
    }

    @Override
    public void ensureAuthorized(Permission permission, Object context) throws UnauthorizedException {
        // do nothing
    }
