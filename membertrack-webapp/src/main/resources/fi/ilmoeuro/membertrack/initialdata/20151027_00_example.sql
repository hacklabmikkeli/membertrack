...
INSERT INTO "SUBSCRIPTION_PERIOD" 
    ("service_id",
     ...
     "approved")
VALUES
    (1,13,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,14,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,16,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,1,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,20,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,21,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,23,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,25,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,27,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,28,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,2,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,30,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,34,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,36,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,37,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,42,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,43,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,48,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,4,{d '2015-1-1'},'YEAR',1,2000,1),
    (1,5,{d '2015-1-1'},'YEAR',1,2000,1),
    (2,14,{d '2015-1-1'},'DAY',30,2000,1),
    (2,15,{d '2015-1-1'},'DAY',30,2000,1),
    (2,17,{d '2015-1-1'},'DAY',30,2000,1),
    (2,18,{d '2015-1-1'},'DAY',30,2000,1),
    (2,21,{d '2015-1-1'},'DAY',30,2000,1),
    (2,22,{d '2015-1-1'},'DAY',30,2000,1),
    (2,23,{d '2015-1-1'},'DAY',30,2000,1),
    (2,24,{d '2015-1-1'},'DAY',30,2000,1),
    (2,25,{d '2015-1-1'},'DAY',30,2000,1),
    (2,28,{d '2015-1-1'},'DAY',30,2000,1),
    (2,29,{d '2015-1-1'},'DAY',30,2000,1),
    (2,30,{d '2015-1-1'},'DAY',30,2000,1),
    (2,31,{d '2015-1-1'},'DAY',30,2000,1),
    (2,34,{d '2015-1-1'},'DAY',30,2000,1),
    (2,35,{d '2015-1-1'},'DAY',30,2000,1),
    (2,36,{d '2015-1-1'},'DAY',30,2000,1),
    (2,37,{d '2015-1-1'},'DAY',30,2000,1),
    (2,39,{d '2015-1-1'},'DAY',30,2000,1),
    (2,41,{d '2015-1-1'},'DAY',30,2000,1),
    (2,46,{d '2015-1-1'},'DAY',30,2000,1),
    (2,4,{d '2015-1-1'},'DAY',30,2000,1),
    (2,50,{d '2015-1-1'},'DAY',30,2000,1),
    (2,5,{d '2015-1-1'},'DAY',30,2000,1),
    (2,6,{d '2015-1-1'},'DAY',30,2000,1);
